...
return [
    ...
    'form' => [
        ...
        'enable_uddoktapay' => 'Enable UddoktaPay',
        'uddoktapay_sandbox_info' => 'When sandbox mode is enabled, payments will be processed in test environment. No real transactions will occur. Get your sandbox API credentials from UddoktaPay Developer Dashboard.',
        'uddoktapay_sandbox_api_url_help' => 'Enter Sandbox API URL. Default: https://sandbox.uddoktapay.com/api/checkout-v2',
        'uddoktapay_sandbox_api_key_help' => 'Enter Sandbox API Key. Default: 982d381360a69d419689740d9f2e26ce36fb7a50',
        'uddoktapay_live_api_url_help' => 'Enter Live API URL from Hosted/Self Hosted panel',
        'uddoktapay_live_api_key_help' => 'Enter Live API Key from Hosted/Self Hosted panel.',
        'uddoktapay_live_verify_url_help' => 'Enter Live Verify URL from Hosted/Self Hosted panel.',
        'uddoktapay_live_refund_url_help' => 'Enter Live Refund URL from Self Hosted panel',
